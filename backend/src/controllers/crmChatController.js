    ...
    (patient.stages || []).forEach((stage) => {
      ...
      if (medicine.status && medicine.status !== 'not_requested') {
        medicineRequestList.push({
          ...
          packagedBy: medicine.packagedByName || '',
          chitsWrittenBy: medicine.chitsWrittenByName || '',
          lastMedicineCheckedBy: medicine.lastMedicineCheckedByName || '',
          packagingDetailsFilledBy: medicine.packagingDetailsFilledByName || '',
          packagingDetailsFilledAt: formatDate(medicine.packagingDetailsFilledAt),
